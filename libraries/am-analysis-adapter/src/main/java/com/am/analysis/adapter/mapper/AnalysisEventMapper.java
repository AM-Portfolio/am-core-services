...
public class AnalysisEventMapper {
                ...
                double computedTotalInvestment = (event.getTotalInvestment() != null && event.getTotalInvestment() > 0)
                                ...
                                : holdings.stream()
                                                .filter(h -> h.getInvestment() != null
                                                                && h.getInvestment().getInvestmentValue() != null)
        ...
        private List<AnalysisHolding> mapEquitiesToHoldings(List<EquityModel> equities, Double totalValue) {
                ...
                return equities.stream()
                                .map(equity -> {
                                        ...
                                        Double invVal = equity.getInvestmentValue() != null
                                                        ? equity.getInvestmentValue()
                                                        : 0.0;
                                        Double curVal = equity.getCurrentValue() != null ? equity.getCurrentValue()
                                                        : value;
                                        Double pnl = equity.getProfitLoss() != null ? equity.getProfitLoss()
                                                        : (curVal - invVal);
                                        Double pnlPct = equity.getProfitLossPercentage() != null
                                        ...
                                        return AnalysisHolding.builder()
                                                        ...
                                                        .market(MarketStats.builder()
                                                                        ...
                                                                        .dayChangePercentage(equity
                                                                                        .getDayChangePercentage() != null
                ...
                return event.getEquityPrices().stream().map(price -> {
                        ...
                        return AnalysisEntity.builder()
                                        ...
                                        .performance(PerformanceSummary.builder()
                                                        ...
                                                        .build())
                                        .lastUpdated(event.getTimestamp() != null ? event.getTimestamp()
                                                        : LocalDateTime.now())
                                        .build();
                }).collect(Collectors.toList());
        }
        ...
        public PortfolioUpdateEvent mapEntityToPortfolioUpdateEvent(AnalysisEntity entity) {
                ...
                PortfolioUpdateEvent event = PortfolioUpdateEvent.builder()
                                ...
                                .equities(equities)
                                .timestamp(entity.getLastUpdated() != null ? entity.getLastUpdated()
                                                : LocalDateTime.now())
                                .build();
        ...
        public com.am.portfolio.domain.dto.PortfolioUpdateDto mapToDto(PortfolioUpdateEvent event) {
                ...
                com.am.portfolio.domain.dto.PortfolioUpdateDto dto = com.am.portfolio.domain.dto.PortfolioUpdateDto
                                .builder()
        ...
        private com.am.portfolio.domain.dto.EquityHoldingDto mapEquityToDto(EquityModel model) {
                return com.am.portfolio.domain.dto.EquityHoldingDto.builder()
                                ...
                                .investmentCost(model.getInvestmentValue()) // Assuming cost is same as init value for
                                                                            // now
