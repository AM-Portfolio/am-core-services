...
public interface AnalysisService {
    AllocationResponse getAllocation(String id, AnalysisEntityType type, String userId);
    PerformanceResponse getPerformance(String id, AnalysisEntityType type, String timeFrame, String userId);
    TopMoversResponse getTopMovers(String id, AnalysisEntityType type, String timeFrame, String userId);
}
